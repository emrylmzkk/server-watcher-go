...
func SetupRoutes(app *fiber.App, container *AppContainer) {
	...
	pm2.Post("/:id/clear-project", container.Pm2Handler.ClearAndDeletePm2Project)
	...
	containerStat.Get("/:containerName/paginate", container.ContainerStatHandler.GetStatsByNameP)
